...
var useResolver = function (_a) {
    ...
    var _b = (0, swr_1.default)([endpoint, request ? { operation: operation, request: request } : null], utils_1.fetcher, __assign({ revalidateOnFocus: false }, fetchParams)), data = _b.data, error = _b.error, mutate = _b.mutate, isValidating = _b.isValidating;
