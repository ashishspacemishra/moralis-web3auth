...
import { BaseAdapter, WALLET_ADAPTERS, ADAPTER_NAMESPACES, ADAPTER_CATEGORY, ADAPTER_STATUS, CHAIN_NAMESPACES, WalletInitializationError, log, ADAPTER_EVENTS, WalletLoginError } from '@web3auth/base';
...
class OpenloginAdapter extends BaseAdapter {
  ...
  _getFinalPrivKey() {
    ...
    if ((_this$openloginOption = this.openloginOptions) !== null && _this$openloginOption !== void 0 && _this$openloginOption.useCoreKitKey && this.openloginInstance.coreKitKey) {
