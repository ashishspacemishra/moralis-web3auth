...
class Web3AuthConnector extends core_namespaceObject.Connector {
  ...
  async switchChain(chainId) {
    try {
      var _chain$blockExplorers, _chain$blockExplorers2, _chain$nativeCurrency;
      ...
      await this.provider.request({
        ...
        params: [{
          ...
          blockExplorerUrls: [(_chain$blockExplorers = chain.blockExplorers) === null || _chain$blockExplorers === void 0 ? void 0 : (_chain$blockExplorers2 = _chain$blockExplorers.default) === null || _chain$blockExplorers2 === void 0 ? void 0 : _chain$blockExplorers2.url],
          nativeCurrency: {
            symbol: ((_chain$nativeCurrency = chain.nativeCurrency) === null || _chain$nativeCurrency === void 0 ? void 0 : _chain$nativeCurrency.symbol) || "ETH"
          }
        }]
      });
      await this.provider.request({
...
/* harmony export */ });
/* harmony import */ var _lib_connector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(915);
